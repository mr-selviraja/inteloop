import { FaLayerGroup, FaRobot, FaBrain, FaUserShield, FaCloud, FaRegSmile } from 'react-icons/fa'
import { MdSpaceDashboard } from "react-icons/md";

const features = [
  {
    icon: <FaLayerGroup className="text-3xl text-teal-600" />,
  ...
  {
    icon: <MdSpaceDashboard className="text-3xl text-teal-600" />,
